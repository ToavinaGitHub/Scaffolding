...
function Region(){
  ...
  const handleSelectItem = (itemKey) => {
    handleShow2();
    const itemDetails = region.find(item => item.idRegion === itemKey);
...
//////// DELETE
  const handleDeleteClick = async (item) => {
	...
	const handleInputIdRegionChange = (event) => {
  ...
  return (
	...
	<div className="mb-3"> 
		...
		<td>{item.idRegion}</td>
                              ...
                              <td>
                                  <Button variant="danger" key={item.idRegion} onClick={() => handleDeleteClick(item)}>
                                      Delete
                                  </Button>
                              </td>   
                              <td>
                                  <Button variant="warning" key={item.idRegion} onClick={() => handleSelectItem(item.idRegion)}>
                                      Update
                                  </Button>
                              </td>
                          </tr>
