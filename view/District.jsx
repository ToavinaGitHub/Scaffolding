...
function District(){
  ...
  const handleSelectItem = (itemKey) => {
    handleShow2();
    const itemDetails = district.find(item => item.idDistrict === itemKey);
...
//////// DELETE
  const handleDeleteClick = async (item) => {
	...
	const handleInputIdDistrictChange = (event) => {
  ...
  return (
	...
	<div className="mb-3"> 
		...
		<td>{item.idDistrict}</td>
                              ...
                              <td>
                                  <Button variant="danger" key={item.idDistrict} onClick={() => handleDeleteClick(item)}>
                                      Delete
                                  </Button>
                              </td>   
                              <td>
                                  <Button variant="warning" key={item.idDistrict} onClick={() => handleSelectItem(item.idDistrict)}>
                                      Update
                                  </Button>
                              </td>
                          </tr>
